    ...
    <app-frame>
        ...
        <div style="padding-left: 20px; ">
            <el-page-header @back="gotoList()" title="返回">
                <template #content>
                    <el-text class="mx-1" size="large">{{ task_id == null ? '' : '查看文件迭代任务详情' }} </el-text>
                </template>
            </el-page-header>
            <hr />
...
const FileTaskDetail = {
    ...
    data() {
        return {
            ...
            task: {
                ...
                llmType: 'Ollama',
                sysPrompt: '请使用中文回答。',
                userPrompt: '${content}。请提取以上内容中的命名实体，并以{实体:实体类别, 实体: 实体类别,}的JSON格式返回。',
                desc: '',
            },
        }
    },
    ...
    template: "#file-task-detail"
};

app.component("file-task-detail", FileTaskDetail);
</script>
<style></style>
