<template id="user-list-image-db">
    <user-frame>
        <div class="container">
            <el-page-header @back="goToMain()" class="page-header">
                <template #content>
                    <el-text class="page-title" size="large">图像库列表</el-text>
                </template>
            </el-page-header>
                    ...
                    <el-card v-for="db in dbs.goodDbs" 
                        ...
                        <el-descriptions class="db-info" :column="2" :size="size" border>
                            ...
                            <el-descriptions-item>
                                ...
                                <el-tag :type="db.buildingPipeline.currentOrd == 2 ? 'success' : 'info'" 
                                       class="status-tag">
...
const UserListImageDb = {
    ...
    methods: {
        gotoSearch(db) {
            ...
            let url = '/user/user_image_db_search/' + db
            location.href = url
        },
    ...
    template: "#user-list-image-db"
};

app.component("user-list-image-db", UserListImageDb);
</script>
