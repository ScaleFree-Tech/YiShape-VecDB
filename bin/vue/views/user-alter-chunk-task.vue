<template id="user-alter-chunk-task">

    <user-frame>
        <div style="padding-left: 20px; width: 96%;">
...
const UserAlterChunkTask = {
    ...
    template: "#user-alter-chunk-task"
};

app.component("user-alter-chunk-task", UserAlterChunkTask);
</script>
<style>
.errorMsg {
    margin-top: -17px;
