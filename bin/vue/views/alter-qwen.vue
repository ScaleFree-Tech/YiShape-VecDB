    ...
    <app-frame>
        ...
        <div style="padding-left: 20px; width: 95%;">
            <el-page-header @back="gotoList()" title="返回">
                <template #content>
                    <el-text class="mx-1" size="large">修改Qwen配置</el-text>
                </template>
            </el-page-header>
            <hr />
            <div class="infoBox">
                <el-text type="primary">
                    Qwen API Key申请地址（第三方，与本软件无关）：
                </el-text>
                <el-link type="warning" href="https://bailian.console.aliyun.com/" target="_blank">阿里云百炼大模型平台</el-link>
            </div>

            <div style="text-align: center;width:100%;">
                <el-form :model="form" label-width="auto">
                    <el-form-item label="API Key">
                        <el-input v-model="form.apiKey" placeholder="请输入Qwen官方所提供的API KEY" type="password"/>
                    </el-form-item>
...
app.component("alter-qwen", AlterQwen);
</script>
<style>
.clearfloat {
