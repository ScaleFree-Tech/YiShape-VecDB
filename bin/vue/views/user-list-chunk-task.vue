<template id="user-list-chunk-task">

    <user-frame>
        <div class="container">
            <el-page-header @back="goToMain()" class="page-header">
                <template #content>
                    <el-text class="page-title" size="large">文本块迭代任务</el-text>
                </template>
            </el-page-header>
                    ...
                    <el-card v-for="(task, index) in tasks" class="box-card" :key="task.id">
                        <template #header>
                            <div class="card-header">
                                <el-link class="bleft" :href="'/mag/chunk_task_detail/' + task.id" type="primary"
                        ...
                        <el-descriptions class="margin-top" :column="2" :size="size" border>
                            ...
                            <el-descriptions-item width="160px">
                                ...
                                <el-tag size="small" :type="task.status == 'FINISHED' ? 'success' : 'warning'">{{
                                    task.status
                                    }}</el-tag>
                            </el-descriptions-item>
                            <el-descriptions-item width="160px">
                            ...
                            <el-descriptions-item span="2">
                                ...
                                <el-button type="primary" text bg title="生成Markdown文件"
                                    :disabled="task.status != 'FINISHED'" @click="makeMd(task.ifOutputChunk, index)">
...
const UserListChunkTask = {
    ...
    methods: {
        ...
        gotoAdd() {
            location.href = ("/user/user_alter_chunk_task")
            // this.$router.push({ path: '/alter_db' })
        },
        gotoAlter(task) {
            location.href = ("/user/user_alter_chunk_task/" + task)
        ...
        doDelete(task) {
            ...
            axios.post(url, params, {
                ...
                location.href = ("/user/user_list_chunk_task")
    ...
    template: "#user-list-chunk-task"
};

app.component("user-list-chunk-task", UserListChunkTask);
</script>
<style>
.container {
    padding: 24px;
