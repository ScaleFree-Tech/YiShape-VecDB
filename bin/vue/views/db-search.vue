                            ...
                            <div id="query1Result" style=" border: 0px solid gray;" v-if="!this.isEmpty(this.result1)">
                                ...
                                <ul>
                                    ...
                                    <li v-for="(item, ind) in result1.items">
                                        ...
                                        <br />
                                        <el-text class="mx-1" type="success">
                                            {{ item.knnType == 'BM25' ? 'BM25得分' : item.disType == 'COS' ? '余弦相似性' : '欧氏距离' }} ：{{ item.distance
                                            }}，
                                        </el-text>
                    ...
                    <div style="border:0px solid red;">
                        ...
                        <div v-loading="loading" class="searchResult">
                            <div id="query2Result" v-if="!this.isEmpty(this.result2)">
                                ...
                                <el-text class="mx-1" v-html="replaceLnWithBr(result2.llmAns)"></el-text>
                            </div>
                    ...
                    <div style="border:0px solid red;">
                        ...
                        <div v-loading="loading" class="searchResult">
                            <div id="query3Result" v-if="!this.isEmpty(this.result3)">
                                <el-divider content-position="left"><el-text class="mx-1"
                                        type="primary">大模型检索增强生成（RAG）结果</el-text></el-divider>
                                <el-text class="mx-1" v-html="replaceLnWithBr(result3.llmRAG)"></el-text>
                                <hr />
                                <ul>
                                    <li>
                                        <el-text class="mx-1" type="success">
...
const DbSearch = {
    mounted() {
        ...
        loadKaTeX().then(() => {
            ...
            // 对已加载的消息进行渲染
            this.$nextTick(() => {
                renderExistingLatex('.searchResult');
            });
        }).catch(error => {
    ...
    methods: {
        ...
        doLLM() {
            ...
            axios.post(url, params, {
                ...
                // this.result2.llmAns = this.result2.llmAns.replace(/(\r\n|\r|\n)/g, '<br/>')
                this.loading = false;
            });
        },
        doRAG() {
            ...
            axios.post(url, params, {
                ...
                // this.result3.llmRAG = this.result3.llmRAG.replace(/(\r\n|\r|\n)/g, '<br/>')
                this.loading = false;
            });
        },
...
app.component("db-search", DbSearch);
</script>
<style>
.clearfloat {
